...
exec_out:
  ...
  if (rc != SQLITE_OK && pzErrMsg && !*pzErrMsg) {
    ...
    *pzErrMsg = sqlite3_strdup("Unknown error in BusTub!");
  }
  return rc;
}
...
int sqlite3_bind_zeroblob(sqlite3_stmt *stmt, int idx, int length) {
...
const char *sqlite3_libversion(void) { return BusTub::LibraryVersion(); }

const char *sqlite3_sourceid(void) { return BusTub::SourceID(); }
...
int sqlite3_changes(sqlite3 *db) { return db->last_changes; }

int sqlite3_total_changes(sqlite3 *db) { return db->total_changes; }

sqlite3_int64 sqlite3_last_insert_rowid(sqlite3 *db) { return SQLITE_ERROR; }
...
int sqlite3_get_autocommit(sqlite3 *db) { return db->con->context->transaction.IsAutoCommit(); }
...
sqlite3 *sqlite3_context_db_handle(sqlite3_context *) { return nullptr; }
...
char *sqlite3_win32_utf8_to_mbcs_v2(const char *zText, int useAnsi) { return winUtf8ToMbcs(zText, useAnsi); }
...
char *sqlite3_win32_mbcs_to_utf8_v2(const char *zText, int useAnsi) { return winMbcsToUtf8(zText, useAnsi); }

char *sqlite3_win32_unicode_to_utf8(LPCWSTR zWideText) { return winUnicodeToUtf8(zWideText); }

#endif

// TODO complain
void sqlite3_result_blob(sqlite3_context *context, const void *blob, int n_bytes, void (*xDel)(void *)) {
  sqlite3_result_blob64(context, blob, n_bytes, xDel);
}

void sqlite3_result_blob64(sqlite3_context *context, const void *blob, sqlite3_uint64 n_bytes, void (*xDel)(void *)) {
  if (!blob) {
...
void sqlite3_result_error(sqlite3_context *context, const char *msg, int n_bytes) {
  context->isError = SQLITE_ERROR;
  sqlite3_result_text(context, msg, n_bytes, nullptr);
}

void sqlite3_result_error16(sqlite3_context *context, const void *msg, int n_bytes) {
...
void sqlite3_result_error_nomem(sqlite3_context *context) { sqlite3_result_error(context, "out of memory", -1); }
...
void sqlite3_result_int(sqlite3_context *context, int val) { sqlite3_result_int64(context, val); }

void sqlite3_result_int64(sqlite3_context *context, sqlite3_int64 val) {
  context->result.u.i = val;
  context->result.type = SQLiteTypeValue::INTEGER;
}

void sqlite3_result_null(sqlite3_context *context) { context->result.type = SQLiteTypeValue::NULL_VALUE; }

void sqlite3_result_text(sqlite3_context *context, const char *str_c, int n_chars, void (*xDel)(void *)) {
  if (!str_c) {
    context->isError = SQLITE_MISUSE;
    return;
  }
...
int sqlite3_result_zeroblob64(sqlite3_context *, sqlite3_uint64 n) { return -1; }

// TODO complain
const void *sqlite3_value_blob(sqlite3_value *pVal) { return sqlite3_value_text(pVal); }
...
const void *sqlite3_value_text16(sqlite3_value *) { return nullptr; }

const void *sqlite3_value_text16le(sqlite3_value *) { return nullptr; }

const void *sqlite3_value_text16be(sqlite3_value *) { return nullptr; }
...
int sqlite3_value_bytes16(sqlite3_value *) { return 0; }

int sqlite3_value_type(sqlite3_value *pVal) { return (int)pVal->type; }

int sqlite3_value_numeric_type(sqlite3_value *) { return 0; }

int sqlite3_value_nochange(sqlite3_value *) { return 0; }

sqlite3_value *sqlite3_value_dup(const sqlite3_value *val) { return new sqlite3_value(*val); }
...
sqlite3 *sqlite3_db_handle(sqlite3_stmt *s) { return s->db; }
...
int sqlite3_keyword_check(const char *str, int len) { return Parser::IsKeyword(std::string(str, len)); }
...
int sqlite3_busy_handler(sqlite3 *, int (*)(void *, int), void *) { return SQLITE_ERROR; }
...
void sqlite3_free_table(char **result) { fprintf(stderr, "sqlite3_free_table: unsupported.\n"); }
...
int sqlite3_threadsafe(void) { return SQLITE_OK; }
...
void sqlite3_mutex_free(sqlite3_mutex *) { fprintf(stderr, "sqlite3_mutex_free: unsupported.\n"); }
...
void *sqlite3_update_hook(sqlite3 *db, /* Attach the hook to this database */
...
void sqlite3_log(int iErrCode, const char *zFormat, ...) { fprintf(stderr, "sqlite3_log: unsupported.\n"); }

int sqlite3_unlock_notify(sqlite3 *db, void (*xNotify)(void **, int), void *pArg) {
...
void *sqlite3_rollback_hook(sqlite3 *db,               /* Attach the hook to this database */
...
void *sqlite3_commit_hook(sqlite3 *db,              /* Attach the hook to this database */
...
int sqlite3_blob_open(sqlite3 *db,          /* The database connection */
...
int sqlite3_create_module_v2(sqlite3 *db,                   /* Database in which module is registered */
