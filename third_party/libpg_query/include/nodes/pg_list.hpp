 ...
 *
 *	bustub_libpgquery::T_PGList: lists of pointers
 *		(in practice usually pointers to Nodes, but not always;
 *		declared as "void *" to minimize casting annoyances)
 *	bustub_libpgquery::T_PGIntList: lists of integers
 *	bustub_libpgquery::T_PGOidList: lists of Oids
 *
...
typedef struct PGList {
	PGNodeTag		type;			/* bustub_libpgquery::T_PGList, bustub_libpgquery::T_PGIntList, or bustub_libpgquery::T_PGOidList */
	int			length;
	PGListCell   *head;
	PGListCell   *tail;
} PGList;
