...
//       // we replace the original subquery with a ColumnRefExpression referring to the result of the projection
//       (either
//       // TRUE or FALSE)
...
//       auto first_agg = AggregateFunction::BindAggregateFunction(binder.context,
//       FirstFun::GetFunction(expr.return_type),
