...
BindResult AggregateBinder::BindExpression(unique_ptr<ParsedExpression> *expr_ptr, uint64_t depth,
...
string AggregateBinder::UnsupportedAggregateMessage() { return "aggregate function calls cannot be nested"; }
}  // namespace bustub
