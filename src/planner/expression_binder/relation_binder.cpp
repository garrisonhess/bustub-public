#include "planner/expression_binder/relation_binder.h"
...
BindResult RelationBinder::BindExpression(unique_ptr<ParsedExpression> *expr_ptr, uint64_t depth,
...
string RelationBinder::UnsupportedAggregateMessage() { return "aggregate functions are not allowed in " + op; }
