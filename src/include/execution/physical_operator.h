...
// #include "common/enums/operator_result_type.h"
// #include "common/enums/physical_operator_type.h"
...
class LocalSinkState {
 public:
  ...
  uint64_t batch_index = INVALID_INDEX;
};
...
class GlobalSourceState {
 public:
  ...
  virtual uint64_t MaxThreads() { return 1; }
};
...
class PhysicalOperator {
 public:
  PhysicalOperator(PhysicalOperatorType type, vector<Type> types) : type(type), types(std::move(types)) {}
 ...
 public:
  ...
  virtual string ParamsToString() const { return ""; }
  ...
  virtual bool Equals(const PhysicalOperator &other) const { return false; }
 ...
 public:
  ...
  virtual uint64_t GetBatchIndex(ExecutionContext &context, DataChunk &chunk, GlobalSourceState &gstate,
                                 LocalSourceState &lstate) const;
  ...
  virtual bool SupportsBatchIndex() const { return false; }
