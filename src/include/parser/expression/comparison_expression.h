...
class ComparisonExpression : public ParsedExpression {
 public:
  ...
  unique_ptr<ParsedExpression> left_;
  unique_ptr<ParsedExpression> right_;
 ...
 public:
  ...
  static string ToString(const T &entry) {
    return entry.left_->ToString() + " " + ExpressionTypeToOperator(entry.type_) + " " + entry.right_->ToString();
  }
};
}  // namespace bustub
