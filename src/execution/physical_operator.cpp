...
#include "execution/operator/set/physical_recursive_cte.h"
...
string PhysicalOperator::GetName() const { return PhysicalOperatorToString(type); }
...
// LCOV_EXCL_START
void PhysicalOperator::Print() const { Printer::Print(ToString()); }
// LCOV_EXCL_STOP
