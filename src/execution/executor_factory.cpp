...
auto ExecutorFactory::CreateExecutor(ExecutorContext *exec_ctx, const AbstractPlanNode *plan)
  ...
  switch (plan->GetType()) {
    ...
    case PlanType::Insert: {
      const auto *insert_plan = dynamic_cast<const InsertPlanNode *>(plan);
      auto child_executor =
    ...
    case PlanType::Update: {
      const auto *update_plan = dynamic_cast<const UpdatePlanNode *>(plan);
    ...
    case PlanType::Delete: {
      const auto *delete_plan = dynamic_cast<const DeletePlanNode *>(plan);
    ...
    case PlanType::Distinct: {
      const auto *distinct_plan = dynamic_cast<const DistinctPlanNode *>(plan);
    ...
    case PlanType::NestedLoopJoin: {
      const auto *nested_loop_join_plan = dynamic_cast<const NestedLoopJoinPlanNode *>(plan);
    ...
    case PlanType::NestedIndexJoin: {
      const auto *nested_index_join_plan = dynamic_cast<const NestedIndexJoinPlanNode *>(plan);
    ...
    case PlanType::HashJoin: {
      const auto *hash_join_plan = dynamic_cast<const HashJoinPlanNode *>(plan);
