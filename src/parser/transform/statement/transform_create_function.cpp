...
// 				}
// 				if (macro_func->default_parameters.find(param->alias) !=
// macro_func->default_parameters.end()) { 					throw ParserException("Duplicate default
// parameter: '%s'", param->alias);
// 				}
...
// 					throw ParserException("Positional parameters cannot come after parameters with a
// default value!");
// 				}
