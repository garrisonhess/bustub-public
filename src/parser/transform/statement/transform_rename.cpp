#include "bustub/parser/statement/alter_statement.hpp"
#include "bustub/parser/transformer.hpp"

namespace bustub {

unique_ptr<AlterStatement> Transformer::TransformRename(bustub_libpgquery::PGNode *node) {
	auto stmt = reinterpret_cast<bustub_libpgquery::PGRenameStmt *>(node);
	D_ASSERT(stmt);
	...
	case bustub_libpgquery::PG_OBJECT_COLUMN: {
		// change column name
	...
	case bustub_libpgquery::PG_OBJECT_DATABASE:
	default:
