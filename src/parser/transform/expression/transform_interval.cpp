...
// unique_ptr<ParsedExpression> Transformer::TransformInterval(bustub_libpgquery::PGIntervalConstant *node) {
...
// 	if (!node->typmods) {
// 		return make_unique<CastExpression>(Type::INTERVAL, move(expr));
// 	}
