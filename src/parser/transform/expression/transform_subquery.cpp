...
unique_ptr<ParsedExpression> Transformer::TransformSubquery(bustub_libpgquery::PGSubLink *root) {
	...
	case bustub_libpgquery::PG_ANY_SUBLINK:
	case bustub_libpgquery::PG_ALL_SUBLINK: {
		...
		if (root->subLinkType == bustub_libpgquery::PG_ALL_SUBLINK) {
	...
	case bustub_libpgquery::PG_EXPR_SUBLINK: {
