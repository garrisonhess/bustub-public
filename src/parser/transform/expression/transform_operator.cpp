...
// 	switch (root->kind) {
// 	case bustub_libpgquery::PG_AEXPR_OP_ALL:
// 	case bustub_libpgquery::PG_AEXPR_OP_ANY: {
// 		// left=ANY(right)
...
// 		if (root->kind == bustub_libpgquery::PG_AEXPR_OP_ALL) {
...
// 	}
// 	case bustub_libpgquery::PG_AEXPR_IN: {
// 		auto left_expr = TransformExpression(root->lexpr);
...
// 		TransformExpressionList(*((bustub_libpgquery::PGList *)root->rexpr), result->children);
// 		return move(result);
// 	}
// 	// rewrite NULLIF(a, b) into CASE WHEN a=b THEN NULL ELSE a END
// 	case bustub_libpgquery::PG_AEXPR_NULLIF: {
// 		vector<unique_ptr<ParsedExpression>> children;
...
// 	case bustub_libpgquery::PG_AEXPR_SIMILAR: {
// 		auto left_expr = TransformExpression(root->lexpr);
// 		auto right_expr = TransformExpression(root->rexpr);
